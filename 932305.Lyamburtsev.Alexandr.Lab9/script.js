...
const btnsContainer = document.querySelector('.calculator_btns');
const input = document.querySelector('.calculator_input input');

btnsContainer.addEventListener('click', ($event) => {
    const el = $event.target;
    const inputVal = input.value;

    if (el.classList.contains('calculator_btn')) {
